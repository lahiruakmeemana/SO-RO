...
class Point_grid:
    def __init__(self,data,direction,resolution=1,ratio=0.75):
        ...
        self.direction = data["direction"] -90
        #print(self.direction)
        self.size = np.array([601,601],dtype=np.int16) //self.resolution
        #print(self.size)
        self.grid = np.ones((151,151)) * 0.5
        self.center = np.array([75,75]) #0,0 point in the grid
